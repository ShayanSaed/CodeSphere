...
namespace CodeSphere.Web.Pages.Bookmarks;
...
public class IndexModel : PageModel
{
    ...
    public IndexModel(IBookmarkService bookmarkService, ICategoryService categoryService, ITagService tagService)
    {
    ...
    public PagedResult<ArticleListItemDto> Bookmarked { get; set; } = new();
    public List<CategoryDto> Categories { get; set; } = new();
    public List<TagDto> Tags { get; set; } = new();

    public PaginationViewModel Pagination => new()
    {
        CurrentPage = Bookmarked.PageNumber,
        TotalPages = Bookmarked.TotalPages,
        PageName = "/Bookmarks/Index",
    ...
    public async Task OnGetAsync()
    {
        ...
        Bookmarked = await _bookmarkService.SearchBookmarksAsync(userId, new ArticleSearchFilterDto
        {
            Keyword = Keyword,
